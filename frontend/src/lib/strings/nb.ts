...
export const strings = {
  ...
  changes: {
    sectionTitle: "Oppdateringer siste 7 dager",
    lastUpdatedLabel: "Sist oppdatert",
    nextUpdateLabel: "Neste oppdatering",
    empty: "Ingen endringer siste 7 dager.",
    emptyLastChecked: "Forrige sjekk",
    notRunYet: "Refresh-jobben er ikke kjørt enda.",
    sourceBrreg: "BRREG",
    sourceKarantene: "KARANTENE",
    typePositionAdded: "Ny rolle",
    typePositionRemoved: "Rolle avsluttet",
    typeKaranteneNew: "Ny avgjørelse",
    groupToday: "I dag",
